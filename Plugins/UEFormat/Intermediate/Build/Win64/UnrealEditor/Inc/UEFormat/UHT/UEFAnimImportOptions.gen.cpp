...
FClassRegistrationInfo Z_Registration_Info_UClass_UEFAnimImportOptions;
UClass* UEFAnimImportOptions::GetPrivateStaticClass()
{
	using TClass = UEFAnimImportOptions;
	if (!Z_Registration_Info_UClass_UEFAnimImportOptions.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("EFAnimImportOptions"),
			Z_Registration_Info_UClass_UEFAnimImportOptions.InnerSingleton,
			StaticRegisterNativesUEFAnimImportOptions,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UEFAnimImportOptions.InnerSingleton;
}
UClass* Z_Construct_UClass_UEFAnimImportOptions_NoRegister()
{
	return UEFAnimImportOptions::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_UEProj_LyraStarterGame_Plugins_UEFormat_Source_UEFormat_Public_Widgets_Anim_UEFAnimImportOptions_h__Script_UEFormat_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UEFAnimImportOptions, UEFAnimImportOptions::StaticClass, TEXT("UEFAnimImportOptions"), &Z_Registration_Info_UClass_UEFAnimImportOptions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEFAnimImportOptions), 3557346731U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UEProj_LyraStarterGame_Plugins_UEFormat_Source_UEFormat_Public_Widgets_Anim_UEFAnimImportOptions_h__Script_UEFormat_1320029133(TEXT("/Script/UEFormat"),
	Z_CompiledInDeferFile_FID_UEProj_LyraStarterGame_Plugins_UEFormat_Source_UEFormat_Public_Widgets_Anim_UEFAnimImportOptions_h__Script_UEFormat_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UEProj_LyraStarterGame_Plugins_UEFormat_Source_UEFormat_Public_Widgets_Anim_UEFAnimImportOptions_h__Script_UEFormat_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
