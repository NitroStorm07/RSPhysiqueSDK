...
FClassRegistrationInfo Z_Registration_Info_UClass_UEFModelFactory;
UClass* UEFModelFactory::GetPrivateStaticClass()
{
	using TClass = UEFModelFactory;
	if (!Z_Registration_Info_UClass_UEFModelFactory.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("EFModelFactory"),
			Z_Registration_Info_UClass_UEFModelFactory.InnerSingleton,
			StaticRegisterNativesUEFModelFactory,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UEFModelFactory.InnerSingleton;
}
UClass* Z_Construct_UClass_UEFModelFactory_NoRegister()
{
	return UEFModelFactory::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_UEProj_LyraStarterGame_Plugins_UEFormat_Source_UEFormat_Public_Factories_UEFModelFactory_h__Script_UEFormat_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UEFModelFactory, UEFModelFactory::StaticClass, TEXT("UEFModelFactory"), &Z_Registration_Info_UClass_UEFModelFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEFModelFactory), 44048762U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UEProj_LyraStarterGame_Plugins_UEFormat_Source_UEFormat_Public_Factories_UEFModelFactory_h__Script_UEFormat_1191064281(TEXT("/Script/UEFormat"),
	Z_CompiledInDeferFile_FID_UEProj_LyraStarterGame_Plugins_UEFormat_Source_UEFormat_Public_Factories_UEFModelFactory_h__Script_UEFormat_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UEProj_LyraStarterGame_Plugins_UEFormat_Source_UEFormat_Public_Factories_UEFModelFactory_h__Script_UEFormat_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
